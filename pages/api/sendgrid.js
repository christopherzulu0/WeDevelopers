...
async function sendEmail(req, res) {
  ...
  try {
    await sendgrid.send({
      ...
      to: "wedeveloperszm@gmail.com", // Your email where you'll receive emails
      from: "christopherzulu04@gmail.com", // your website email address here
      subject: `[WeDevelopers] : ${req.body.subject}`,
      ...
      <body>
        <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">
              ...
              <img src="https://we-developers.vercel.app/logo.png" class="logo-image" style="height: 50px;width: 50px;border-radius: 5px;overflow: hidden;">
              <p class="footer" style="font-size: 16px;padding-bottom: 20px;border-bottom: 1px solid #D1D5DB;">Regards<br>Geofry Zimba<br>CEO & Founder Of WeDevelopers,<br>+0777603060</p>
